...
     ];
     var callback = () => api.sendMessage({body:`☟  ========== ☟ ==========  ☟                                                         ●===========================●                              𝐎𝐰𝐧𝐞𝐫➻ ╔╬⓼★⓼╃───────➣™🅑︎🅞︎🅣︎ 🅞︎🅦︎🅝︎🅔︎🅡︎ 🅢︎🅤︎🅗︎🅔︎🅑︎ 🅚︎🅗︎🅐︎🅝︎𝄠━─━Ⓔ╰✾✾®️╀✿✿╀─━ↈⓇ⧐⧐💐`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"));  
