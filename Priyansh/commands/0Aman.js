...
module.exports.run = async function ({ api, event, args }) {
  ...
  if (input === "on") {
    ...
    return api.sendMessage("Hyee jaanu! 😏 SK auto-reply mode **ON** ho gaya... Ab sirf tumhare liye naughty romantic bann gaya hu ❤️", threadID, messageID);
  }

  if (input === "off") {
    chatMemory.autoReply[senderID] = false;
    chatMemory.history[senderID] = [];
    return api.sendMessage("Hmm! sk chala gaya... Par tumhara intezaar hamesha rahega jaan ❤️", threadID, messageID);
  }
