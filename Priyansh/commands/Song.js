...
module.exports.handleReply = async function ({ api, event, handleReply }) {
    ...
    try {
        ...
        if (fs.statSync(path).size > 26214400) return api.sendMessage('Bhai ye file 25MB se zeyada hai Nahi bejh sak tha sorry.', event.threadID, () => fs.unlinkSync(path), event.messageID);
